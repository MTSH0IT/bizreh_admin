...
class AllSubCategoryDataTable extends StatelessWidget {
  final List<AllSubCategoryModel> rows;
  final ValueChanged<AllSubCategoryModel>? onEdit;
  final ValueChanged<AllSubCategoryModel>? onDelete;

  const AllSubCategoryDataTable({
    super.key,
    required this.rows,
    this.onEdit,
    this.onDelete,
  ...
  Widget build(BuildContext context) {
    return DataTableWidget<AllSubCategoryModel>(
      rows: rows,
      ...
      buildCells: (sub, index) {
        return [
          ...
          DataCell(DataTableTextCell(text: sub.categoryTitle)),
          DataCell(DataTableTextCell(text: sub.superCategoryTitle)),
