    ...
    return AppFormDialog(
      ...
      child: Column(
        ...
        children: [
          ...
          LabeledTextField(
            label: 'Amount',
            hint: 'Value of discount (fixed: 50 = 50, percentage: 20 = 20%)',
            ...
            final items = controller.products
                ...
                .map(
                  (p) => DropdownMenuItem<int>(
                    value: p.id,
                    child: Text(
                      p.title?.isNotEmpty == true ? p.title! : p.arTitle ?? '-',
                    ),
                  ),
                )
                .toList();
            ...
            final items = controller.brands
                ...
                .map(
                  (b) => DropdownMenuItem<int>(
                    value: b.id,
                    child: Text(
                      b.title?.isNotEmpty == true ? b.title! : b.arTitle ?? '-',
                    ),
                  ),
                )
                .toList();
            ...
            final items = controller.categories
                ...
                .map(
                  (c) => DropdownMenuItem<int>(
                    value: c.id,
                    child: Text(
                      c.title?.isNotEmpty == true ? c.title! : c.arTitle ?? '-',
                    ),
                  ),
                )
                .toList();
